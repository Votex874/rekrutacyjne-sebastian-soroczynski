  ...
  render() {
    ...
    return (
      <div>
        ...
        <Grid container justify="center" alignItems="center" direction="row" spacing={24} style={{ padding: 24 }} >
          {jedi.map((e, i) => (
            <Grid key={i} container justify="center" style={{ padding: 12 }} xs={12} sm={6} lg={4} xl={3}>
              <Skywalker data={e} />
