      ...
      <React.Fragment>
        <Card className={classes.cardStyles}>
          <CardContent className={classes.borderCard} style={{ borderColor: colorDependentOfGender }} >
            <Typography gutterBottom variant="h5" component="h1" className={classes.starWarsText} style={{ textShadow: '1px 1px 2px yellow' }} >
              N: {data.name}
            </Typography>
            ...
            <CardActions>
              <IconButton onClick={() => this.handleDeleteJedi(id)} style={{ marginLeft: 'auto' }} aria-label="Delete">
                <DeleteIcon />
              </IconButton>
            </CardActions>
          </CardContent>
