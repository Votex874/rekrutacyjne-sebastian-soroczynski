  ...
  render() {
    ...
    return (
      <div>
        ...
        <Grid container justify="center" alignItems="center" direction="column" spacing={24} style={{ padding: 48 }} >
          {jedi.map((e, i) => (
            <Grid container justify="center" style={{ padding: 12 }} xs={12} sm={6} lg={4} xl={3}>
              {e.name}
