...
class SkywalkersList extends PureComponent {
  ...
  render() {
    ...
    return (
      <div>
        <AppBar my={1} className={classes.bgNavbar} position="static">
          <Toolbar my={1}>
            <Typography my={1} className={classes.starWarsText} variant="h2" color="inherit">List of skywalkers: </Typography>
          </Toolbar>
        </AppBar>
